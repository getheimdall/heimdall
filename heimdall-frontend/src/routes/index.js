...
const routes = ({ history }) => (
    <Switch>
        ...
        <AppRoute layout={MainLayout} history={history} exact path="/apis"
                  component={Authorization([privileges.PRIVILEGE_READ_API])(FadeIn(Apis))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/apis/new"
        ...
        <AppRoute layout={MainLayout} history={history} path="/apis/:id/interceptors"
                  component={Authorization([privileges.PRIVILEGE_READ_API, privileges.PRIVILEGE_READ_INTERCEPTOR])(FadeIn(ApiInterceptors))}/>
        <AppRoute layout={MainLayout} history={history} path="/apis/:id/resources/:id"
                  component={Authorization([privileges.PRIVILEGE_READ_API, privileges.PRIVILEGE_READ_RESOURCE])(FadeIn(SingleResource))}/>
        <AppRoute layout={LoginLayout} history={history} exact path="/login" component={LoginContainer}/>
        <AppRoute layout={MainLayout} history={history} exact path="/environments"
                  component={Authorization([privileges.PRIVILEGE_READ_ENVIRONMENT])(FadeIn(Environments))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/environments/new"
                  component={Authorization([privileges.PRIVILEGE_CREATE_ENVIRONMENT, privileges.PRIVILEGE_UPDATE_ENVIRONMENT])(FadeIn(SingleEnvironment))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/environments/:id"
                  component={Authorization([privileges.PRIVILEGE_READ_ENVIRONMENT])(FadeIn(SingleEnvironment))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/developers"
                  component={Authorization([privileges.PRIVILEGE_READ_DEVELOPER])(FadeIn(Developers))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/developers/new"
                  component={Authorization([privileges.PRIVILEGE_CREATE_DEVELOPER, privileges.PRIVILEGE_UPDATE_DEVELOPER])(FadeIn(SingleDeveloper))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/developers/:id"
                  component={Authorization([privileges.PRIVILEGE_READ_DEVELOPER])(FadeIn(SingleDeveloper))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/apps"
                  component={Authorization([privileges.PRIVILEGE_READ_APP])(FadeIn(Apps))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/apps/new"
                  component={Authorization([privileges.PRIVILEGE_CREATE_APP, privileges.PRIVILEGE_UPDATE_APP])(FadeIn(SingleApp))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/apps/:id"
                  component={Authorization([privileges.PRIVILEGE_READ_APP])(FadeIn(SingleApp))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/plans"
                  component={Authorization([privileges.PRIVILEGE_READ_PLAN])(FadeIn(Plans))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/plans/new"
                  component={Authorization([privileges.PRIVILEGE_CREATE_PLAN, privileges.PRIVILEGE_UPDATE_PLAN])(FadeIn(SinglePlan))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/plans/:id"
                  component={Authorization([privileges.PRIVILEGE_READ_PLAN])(FadeIn(SinglePlan))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/tokens"
                  component={Authorization([privileges.PRIVILEGE_READ_ACCESSTOKEN])(FadeIn(AccessTokens))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/tokens/new"
                  component={Authorization([privileges.PRIVILEGE_CREATE_ACCESSTOKEN, privileges.PRIVILEGE_UPDATE_ACCESSTOKEN])(FadeIn(SingleAccessToken))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/tokens/:id"
        ...
        <AppRoute layout={MainLayout} history={history} exact path="/users/:id"
                  component={Authorization([privileges.PRIVILEGE_READ_USER])(FadeIn(SingleUser))}/>
        <AppRoute layout={MainLayout} history={history} exact path="/traces"
