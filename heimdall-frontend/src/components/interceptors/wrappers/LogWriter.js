...
class LogWriter extends React.Component {
        ...
        return(
            <React.Fragment>
                ...
                </Col>
                {
                    this.state.header &&
                    <Col sm={4} md={24}>
                        <FormItem label={i18n.t('required_headers')}>
                            {
                                getFieldDecorator('content.requiredHeaders', {
                                    initialValue: content ? content.requiredHeaders : 'headerName',
