                                    ...
                                    <FormItem label={i18n.t('environments')}>
                                        {
                                            ...
                                            })(<Checkbox.Group className='checkbox-conductor checkbox-conductor-environments' options={options} disabled={!PrivilegeUtils.verifyPrivileges([privileges.PRIVILEGE_UPDATE_API])}/>)
                                        }
                                    </FormItem>
                                </Col>
                            </Row>
