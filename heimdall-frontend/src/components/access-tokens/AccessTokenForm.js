            ...
            <Row>
                            ...
                            <FormItem label="App">
                                {
                                    getFieldDecorator('app.id', {
                                        ...
                                        rules: [
                                            { validator: this.checkApp, transform: (value) => Number(value), required: true }
                                        ]
                                    })(
                                        <AutoComplete
                ...
                <Row type="flex" justify="end">
                    <Tooltip title="Delete">
                        <Button className="card-button" type="danger" ghost icon="delete" size="large" shape="circle" disabled={!accessToken} onClick={accessToken && this.showDeleteConfirm(accessToken.id)} loading={loading} />
                    </Tooltip>
                    <Tooltip title="Save">
