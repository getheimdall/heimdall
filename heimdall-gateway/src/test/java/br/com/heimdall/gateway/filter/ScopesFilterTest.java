...
public class ScopesFilterTest {
    ...
    public void clientIdNotInScope() {
        ...
        this.request.addHeader(ConstantsContext.CLIENT_ID, clientId1);
        ...
        context.set(ConstantsContext.OPERATION_ID, operation.getId() + 1);
    ...
    public void clientIdAllowedInScope() {
        ...
        context.set(ConstantsContext.OPERATION_ID, operation.getId());
    ...
    public void multiplePlansSuccess() {
        ...
        context.set(ConstantsContext.OPERATION_ID, operation1.getId());
    ...
    public void multiplePlansFailure() {
        this.request.addHeader(ConstantsContext.CLIENT_ID, clientId2);
        ...
        context.set(ConstantsContext.OPERATION_ID, operation1.getId());
        context.set(ConstantsContext.API_ID, api2.getId());
    ...
    public void overlappingPlansApp1() {
        ...
        context.set(ConstantsContext.OPERATION_ID, operation3.getId());
        context.set(ConstantsContext.API_ID, api1.getId());
    ...
    public void overlappingPlansApp2() {
        ...
        context.set(ConstantsContext.OPERATION_ID, operation2.getId());
        context.set(ConstantsContext.API_ID, api1.getId());
    ...
    public void noClientIdHeader() {
        ...
        context.set(ConstantsContext.OPERATION_ID, operation.getId());
        context.set(ConstantsContext.API_ID, api.getId());
