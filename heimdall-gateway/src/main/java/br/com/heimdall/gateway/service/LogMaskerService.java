...
/**
 * Log Mask Service provides a method to mask the information from the {@link Trace}.
 *
...
public class LogMaskerService {
    ...
    /**
     * Given the filter type it removes the information passed from the {@link Trace}.
     *
