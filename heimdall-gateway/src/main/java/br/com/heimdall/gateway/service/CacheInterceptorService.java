...
import br.com.heimdall.middleware.spec.Helper;
...
import static br.com.heimdall.core.util.ConstantsCache.CACHE_BUCKET;
import static br.com.heimdall.core.util.ConstantsCache.CACHE_TIME_TO_LIVE;
...
public class CacheInterceptorService {
    ...
    private String createCacheKey(RequestContext context, String cacheName, List<String> headers, List<String> queryParams) {
        ...
        cacheKey.append(context.get(ConstantsContext.API_ID));
        cacheKey.append("-");
        cacheKey.append(context.get(ConstantsContext.API_NAME));
        cacheKey.append(":");
    ...
    private String createDeleteCacheKey(RequestContext context, String cacheName) {
        ...
        return context.get(ConstantsContext.API_ID) + "-" +
                context.get(ConstantsContext.API_NAME) + ":" +
                cacheName + ":*";
    }
