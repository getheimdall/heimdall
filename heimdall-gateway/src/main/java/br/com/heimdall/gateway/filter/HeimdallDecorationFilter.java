...
import br.com.heimdall.core.util.ConstantsPath;
import br.com.heimdall.core.util.UrlUtil;
import br.com.heimdall.gateway.router.Credential;
import br.com.heimdall.gateway.router.CredentialRepository;
import br.com.heimdall.gateway.router.EnvironmentInfo;
import br.com.heimdall.gateway.router.EnvironmentInfoRepository;
import br.com.heimdall.gateway.util.RequestHelper;
import br.com.heimdall.gateway.zuul.route.HeimdallRoute;
import br.com.heimdall.gateway.zuul.route.ProxyRouteLocator;
            ...
            if (Objects.nonNull(entry.getKey())){
                ...
                if (this.pathMatcher.match(pattern, requestURI)) {
                    ...
                    if (credential != null) {
                        ...
                        ctx.put(ConstantsContext.PATTERN, org.apache.commons.lang.StringUtils.removeStart(pattern, basePath));
                        ctx.put(ConstantsContext.API_NAME, credential.getApiName());
                        ctx.put(ConstantsContext.API_ID, credential.getApiId());
                        ctx.put(ConstantsContext.RESOURCE_ID, credential.getResourceId());
                        ctx.put(ConstantsContext.OPERATION_ID, credential.getOperationId());
                        ctx.put(ConstantsContext.OPERATION_PATH, credential.getOperationPath());
                        ...
                        if (Objects.nonNull(environment)) {
                            ...
                            ctx.put(ConstantsContext.ENVIRONMENT_VARIABLES, environment.getVariables());
                        }
