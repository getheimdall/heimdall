...
//
//          Mockito.when(this.environmentRepository.findOne(Mockito.anyString())).thenReturn(environment);
//          Environment environmentResp = environmentService.find("1");
//          assertEquals(environmentResp.getId(), environment.getId());
//          Mockito.verify(this.environmentRepository, Mockito.times(1)).findOne(Mockito.anyString());
//     }
//
//     @Test
...
//
//          Mockito.when(environmentRepository.save(Mockito.any(Environment.class))).thenReturn(environment);
//          Mockito.when(environmentRepository.findOne(Mockito.anyString())).thenReturn(environment);
//
