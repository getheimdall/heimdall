...
public class MiddlewareResource {
     ...
     public ResponseEntity<?> findById(@PathVariable("apiId") String apiId, @PathVariable("middlewareId") String middlewareId) {
     ...
     @GetMapping
     @PreAuthorize(ConstantsPrivilege.PRIVILEGE_READ_MIDDLEWARE)
     public ResponseEntity<?> findAll(@PathVariable("apiId") String apiId, @ModelAttribute MiddlewareDTO middlewareDTO, @ModelAttribute PageableDTO pageableDTO) {
     ...
     public ResponseEntity<?> update(@PathVariable("apiId") String apiId, @PathVariable("middlewareId") String middlewareId, @RequestBody MiddlewareDTO middlewareDTO) {
     ...
     public ResponseEntity<?> delete(@PathVariable("apiId") String apiId, @PathVariable("middlewareId") String middlewareId) {
     ...
     @PreAuthorize(ConstantsPrivilege.PRIVILEGE_READ_MIDDLEWARE)
     public ResponseEntity<?> downloadFileById(@PathVariable("apiId") String apiId, @PathVariable("middlewareId") String middlewareId){
