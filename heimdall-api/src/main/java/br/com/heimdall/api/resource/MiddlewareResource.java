...
import br.com.heimdall.core.service.MiddlewareService;
...
import static br.com.heimdall.core.util.ConstantsPath.PATH_MIDDLEWARES;
...
public class MiddlewareResource {
     ...
     public ResponseEntity<Middleware> findById(@PathVariable("apiId") Long apiId, @PathVariable("middlewareId") Long middlewareId) {
     ...
     public ResponseEntity<String> save(@PathVariable("apiId") Long apiId,
     ...
     public ResponseEntity<Middleware> update(@PathVariable("apiId") Long apiId, @PathVariable("middlewareId") Long middlewareId, @RequestBody MiddlewareDTO middlewareDTO) {
     ...
     public ResponseEntity<Void> delete(@PathVariable("apiId") Long apiId, @PathVariable("middlewareId") Long middlewareId) {
