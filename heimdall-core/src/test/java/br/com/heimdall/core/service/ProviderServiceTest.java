...
import br.com.heimdall.core.dto.ProviderParamsDTO;
...
import br.com.heimdall.core.repository.ProviderRepository;
...
public class ProviderServiceTest {
	...
	public void testListWithPageableAndFilter() {
		...
		Assert.assertEquals(1L, providerPageResp.getTotalElements());
