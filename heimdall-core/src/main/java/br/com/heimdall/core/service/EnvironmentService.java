...
public class EnvironmentService {
    ...
    public Environment find(Long id) {
        ...
        HeimdallException.checkThrow(environment == null, ExceptionMessage.GLOBAL_RESOURCE_NOT_FOUND);
    ...
    public Environment save(EnvironmentDTO environmentDTO) {
        ...
        Environment environment = GenericConverter.mapper(environmentDTO, Environment.class);
        HeimdallException.checkThrow(!validateInboundURL(environment.getInboundURL()), ExceptionMessage.ENVIRONMENT_INBOUND_DNS_PATTERN);
    ...
    public Environment update(Long id, EnvironmentDTO environmentDTO) {
     ...
     public void delete(Long id) {
        ...
        HeimdallException.checkThrow(totalEnvironmentsAttached > 0, ExceptionMessage.ENVIRONMENT_ATTACHED_TO_API);
