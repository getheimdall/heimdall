...
public class MiddlewareService {
     ...
     public Middleware find(Long apiId, Long middlewareId) {
          ...
          HeimdallException.checkThrow(middleware == null, ExceptionMessage.GLOBAL_RESOURCE_NOT_FOUND);
     ...
     public Middleware save(Long apiId, MiddlewareDTO middlewareDTO, MultipartFile file) {
          ...
          HeimdallException.checkThrow(resData != null &&
                  (Objects.equals(resData.getApi().getId(), api.getId())), ExceptionMessage.ONLY_ONE_MIDDLEWARE_PER_VERSION_AND_API);

          String type = FilenameUtils.getExtension(file.getOriginalFilename());
          HeimdallException.checkThrow(!("jar".equalsIgnoreCase(type)), ExceptionMessage.MIDDLEWARE_UNSUPPORTED_TYPE);
     ...
     public Middleware update(Long apiId, Long middlewareId, MiddlewareDTO middlewareDTO) {
          ...
          HeimdallException.checkThrow(resData != null &&
                  ...
                  !Objects.equals(resData.getId(), middleware.getId()), ExceptionMessage.ONLY_ONE_MIDDLEWARE_PER_VERSION_AND_API);
