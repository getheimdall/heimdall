...
public class AccessTokenService {
     ...
     public AccessToken find(Long id) {
          ...
          HeimdallException.checkThrow(accessToken == null, ExceptionMessage.GLOBAL_RESOURCE_NOT_FOUND);
     ...
     public AccessToken save(AccessTokenPersist accessTokenPersist) {
          ...
          HeimdallException.checkThrow(appRecover == null, ExceptionMessage.APP_NOT_EXIST);
          HeimdallException.checkThrow(!verifyIfPlansContainsInApp(appRecover, accessTokenPersist.getPlans()), ExceptionMessage.SOME_PLAN_NOT_PRESENT_IN_APP);
          ...
          if (accessToken.getCode() != null) {
               ...
               HeimdallException.checkThrow(existAccessToken != null, ExceptionMessage.ACCESS_TOKEN_ALREADY_EXISTS);
          } else {
     ...
     public AccessToken save(AccessTokenDTO reqBody) {
          ...
          HeimdallException.checkThrow(accessToken.getCode() == null, ExceptionMessage.ACCESS_TOKEN_NOT_DEFINED);
