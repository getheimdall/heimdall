...
public class InterceptorService {
    ...
    public Interceptor find(Long id) {
        ...
        HeimdallException.checkThrow(interceptor == null, ExceptionMessage.GLOBAL_RESOURCE_NOT_FOUND);
    ...
    public Interceptor save(InterceptorDTO interceptorDTO) {
        ...
        HeimdallException.checkThrow(!ignoredResources.isEmpty(), ExceptionMessage.INTERCEPTOR_IGNORED_INVALID, ignoredResources.toString());

        List<Long> ignoredOperations = ignoredValidate(interceptorDTO.getIgnoredOperations(), operationRepository);
        HeimdallException.checkThrow(!ignoredOperations.isEmpty(), ExceptionMessage.INTERCEPTOR_IGNORED_INVALID, ignoredOperations.toString());

        HeimdallException.checkThrow((TypeInterceptor.CLIENT_ID.equals(interceptor.getType()) && InterceptorLifeCycle.PLAN.equals(interceptor.getLifeCycle())), ExceptionMessage.INTERCEPTOR_INVALID_LIFECYCLE, interceptor.getType().name());
        HeimdallException.checkThrow((TypeInterceptor.MIDDLEWARE.equals(interceptor.getType()) && !InterceptorLifeCycle.OPERATION.equals(interceptor.getLifeCycle())),
                                     ExceptionMessage.MIDDLEWARE_NO_OPERATION_FOUND, interceptor.getType().name());
    ...
    private Interceptor validateLifeCycle(Interceptor interceptor) {
        ...
        switch (interceptor.getLifeCycle()) {
            case API:
                ...
                HeimdallException.checkThrow(api == null, ExceptionMessage.INTERCEPTOR_REFERENCE_NOT_FOUND);
            ...
            case PLAN:
                ...
                HeimdallException.checkThrow(plan == null, ExceptionMessage.INTERCEPTOR_REFERENCE_NOT_FOUND);
                interceptor.setResource(null);
                interceptor.setOperation(null);
            ...
            case RESOURCE:
                ...
                HeimdallException.checkThrow(resource == null, ExceptionMessage.INTERCEPTOR_REFERENCE_NOT_FOUND);
                interceptor.setOperation(null);
                interceptor.setPlan(null);
            ...
            case OPERATION:
                Operation operation = operationRepository.findOne(interceptor.getReferenceId());
                HeimdallException.checkThrow(operation == null, ExceptionMessage.INTERCEPTOR_REFERENCE_NOT_FOUND);
                interceptor.setResource(null);
                interceptor.setPlan(null);
