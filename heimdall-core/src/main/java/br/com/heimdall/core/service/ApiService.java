...
import br.com.heimdall.core.dto.*;
...
public class ApiService {
    ...
    public Api find(Long id) {
        ...
        HeimdallException.checkThrow(api == null, ExceptionMessage.GLOBAL_RESOURCE_NOT_FOUND);
    ...
    public Api save(ApiDTO apiDTO) {
        ...
        HeimdallException.checkThrow(validateApi != null, ExceptionMessage.API_BASEPATH_EXIST);
        HeimdallException.checkThrow(validateBasepath(apiDTO), ExceptionMessage.API_BASEPATH_MALFORMED);
        HeimdallException.checkThrow(apiDTO.getBasePath() == null || apiDTO.getBasePath().isEmpty(), ExceptionMessage.API_BASEPATH_EMPTY);
        HeimdallException.checkThrow(validateInboundsEnvironments(apiDTO.getEnvironments()), ExceptionMessage.API_CANT_ENVIRONMENT_INBOUND_URL_EQUALS);
    ...
    public Api update(Long id, ApiDTO apiDTO) {
        ...
        Api validateApi = apiRepository.findByBasePath(apiDTO.getBasePath());
        HeimdallException.checkThrow(validateApi != null && !Objects.equals(validateApi.getId(), api.getId()), ExceptionMessage.API_BASEPATH_EXIST);
        HeimdallException.checkThrow(validateBasepath(apiDTO), ExceptionMessage.API_BASEPATH_MALFORMED);
        HeimdallException.checkThrow(apiDTO.getBasePath() == null || apiDTO.getBasePath().isEmpty(), ExceptionMessage.API_BASEPATH_EMPTY);
        HeimdallException.checkThrow(validateInboundsEnvironments(apiDTO.getEnvironments()), ExceptionMessage.API_CANT_ENVIRONMENT_INBOUND_URL_EQUALS);
    ...
    public Api updateBySwagger(Long id, String swagger, boolean override) {
        ...
        try {
            ...
            HeimdallException.checkThrow(api == null, ExceptionMessage.GLOBAL_SWAGGER_JSON_INVALID_FORMAT);
        }
    ...
    public void delete(Long id) {
     ...
     public List<Plan> plansByApi(Long id) {
          ...
          HeimdallException.checkThrow(Objects.isNull(found), ExceptionMessage.API_NOT_EXIST);
