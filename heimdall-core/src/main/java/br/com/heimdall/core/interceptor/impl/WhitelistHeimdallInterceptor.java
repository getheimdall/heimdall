...
import br.com.heimdall.core.dto.interceptor.IpsDTO;
...
public class WhitelistHeimdallInterceptor implements HeimdallInterceptor {
    ...
    public IpsDTO parseContent(String content) {
        try {
            ...
            ExceptionMessage.INTERCEPTOR_INVALID_CONTENT.raise(TypeInterceptor.WHITELIST.name(), TemplateUtils.TEMPLATE_BLOCK_IPS);
        }
