...
public class ResourceService {
     ...
     public Resource save(Long apiId, ResourceDTO resourceDTO) {
          ...
          HeimdallException.checkThrow(resData != null &&
                  Objects.equals(resData.getApi().getId(), api.getId()), ExceptionMessage.ONLY_ONE_RESOURCE_PER_API);
     ...
     public Resource update(Long apiId, Long resourceId, ResourceDTO resourceDTO) {
          ...
          HeimdallException.checkThrow(resData != null &&
                  ...
                  !Objects.equals(resData.getId(), resource.getId()), ExceptionMessage.ONLY_ONE_RESOURCE_PER_API);
